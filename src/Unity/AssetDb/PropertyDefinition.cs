...
public class PropertyDefinition
{
    ...
    static readonly PropertyDefinition[] k_all =
    {
        ...
        /*NamedPPtrArrayPropertyDefinition kMonoScriptDefaultReferencesPropDef*/ new("MonoImporter.defaultReferences",  true,  LmdbValue.Type.NamedPPtrArray),
        /*BlobPPtrPropertyDefinition kMonoScriptIconPropDef*/                    new("MonoImporter.icon",               true,  LmdbValue.Type.BlobPPtr),
        /*SInt32PropertyDefinition kMonoScriptExecutionOrderPropDef*/            new("MonoImporter.executionOrder",     true,  LmdbValue.Type.SInt32),
